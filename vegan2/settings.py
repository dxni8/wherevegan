...
"""
Django settings for vegan2 project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'wherevegan.herokuapp.com', 'www.wherevegan.de', 'wherevegan.de']
...
WSGI_APPLICATION = "vegan2.wsgi.application"
