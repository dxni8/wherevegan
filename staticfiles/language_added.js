...
function english(){
    ...
    document.querySelector('.important').innerHTML = 'Therefore, as a last step, please send photos of your current menu to our email address menu@wherevegan.de with your registered email address. Please do not forget to include the name of your restaurant and the address, otherwise we will not know to which restaurant the respective menu belongs.'
